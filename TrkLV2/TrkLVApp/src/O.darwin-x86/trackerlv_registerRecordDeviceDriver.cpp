...
/* Generated from ../O.Common/trackerlv.dbd */
...
static const char * const deviceSupportNames[] = {
    ...
    "devBiSoftRaw", "devBiSoftCallback", "devBiDbState", "devBiTracker",
    "devBoSoft", "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "devBoTracker", "devCalcoutSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devBiDbState, pvar_dset_devBiTracker, pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw, pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime, pvar_dset_devBoDbState,
    pvar_dset_devBoTracker, pvar_dset_devCalcoutSoft,
    pvar_dset_devCalcoutSoftCallback, pvar_dset_devEventSoft,
...
int trackerlv_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/Users/odell/tracker_dcs/tracker_dcs/TrkLV2";
...
/* trackerlv_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"trackerlv_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    trackerlv_registerRecordDeviceDriver(*iocshPpdbbase);
}
